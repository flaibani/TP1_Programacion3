...
def main() -> None:
    ...
    algos = {HILL_CLIMBING: search.HillClimbing(),
             ...
             TABU_SEARCH: search.Tabu(round(number_nodes/2),number_nodes*5),
             TABU_SEARCH_VARIANTE: search.TabuVariante(max_tabu_size=round(number_nodes/2),limit_iters_without_progress=number_nodes*5,number_best_actions=round(number_nodes/3))}
